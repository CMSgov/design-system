...
function App() {
  ...
  return (
    <>
      <h1>A starting point for implementers</h1>
      <VariantGroup label="typography">
      ...
      <VariantGroup label="Components">
        ...
        <VariantGroup label="pill aka badge (with close / without)">
        ...
        <VariantGroup label="alert (with buttons)">
          <Alert heading="Log in to your account to continue">
            <p className="ds-c-mgov-type--body">
              It looks like you may be logged out of your account. Log in to your account to
              continue.
            </p>
        ...
        <VariantGroup label="alert (lightweight)">
          ...
          >
            <p className="ds-c-mgov-type--body">
              Based on your income, you may qualify for a plan that costs less than your current
              plan.
            </p>
          </Alert>
        </VariantGroup>
        ...
        <VariantGroup label="dialog (modal)">
          ...
          >
            <p className="ds-c-mgov-type--body">
              <strong>Abilify</strong> comes in a generic version called{' '}
              <strong>aripiprazole</strong> that may cost less. Would you like to add{' '}
              <strong>aripiprazole</strong> to your drug list instead?
            </p>
          </Dialog>
        </VariantGroup>
        ...
        <VariantGroup label="choice block aka choicelist (radio)">
          <ChoiceBlock
            name="cb-radio"
            type="radio"
        ...
        <VariantGroup label="choice block aka choicelist (checkbox)">
          <ChoiceBlock
            name="cb-check"
            type="checkbox"
            label="Add coverage"
