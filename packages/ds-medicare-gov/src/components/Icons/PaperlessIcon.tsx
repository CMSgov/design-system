...
function PaperlessIcon(props: IconCommonProps): React.ReactElement {
  const iconCssClasses = `ds-c-icon--paperless ${props.className || ''}`;

  return (
    <span className="icon-wrapper">
      <SvgIcon title={t('icons.paperless')} {...defaultProps} {...props} className={iconCssClasses}>
        <path
