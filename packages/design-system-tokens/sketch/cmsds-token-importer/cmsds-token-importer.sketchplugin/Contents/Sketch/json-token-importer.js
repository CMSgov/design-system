        ...
        /***/ function (module, __webpack_exports__, __webpack_require__) {
          ...
          function updateComponentTextStyles(doc, _ref) {
            var componentName = _ref.componentName,
              ...
              folder = _ref.folder;
            var rawTextStyles = {}; // Go through each token and put it into a bucket based on information stored in its key
            ...
            for (var tokenName in componentTokens) {
              ...
              for (var propertyName in tokenNamePatterns) {
                ...
                if (matchResults) {
                  var _matchResults$slice = matchResults.slice(1),
                    _matchResults$slice2 = _slicedToArray(_matchResults$slice, 2),
                    prefix = _matchResults$slice2[0],
            ...
            var getProperty = function getProperty(textStyleName, propertyName, parseFn) {
              var rawTextStyle = rawTextStyles[textStyleName];
          ...
          function updateTextStylesFromTheme(doc, themeTokens) {
            ...
            for (
              var _i2 = 0, _Object$entries = Object.entries(components);
