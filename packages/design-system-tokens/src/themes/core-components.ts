...
export const components = {
  ...
  'autocomplete': {
    '-list__background-color':                    t.color['white'],
    '-list__border-color':                        t.color['gray-lighter'],
    '-list-item__font-color':                     t.color['primary'],
    '-list-item__background-color--active':       t.color['primary-alt-darkest'],
    '-list-item__font-color--active':             t.color['white'],
    '-list-item-message__font-color':             t.color['muted'],
  },
