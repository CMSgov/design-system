...
export const components: AnyTokenValues = {
  ...
  'button-solid-alt': {
    '__background-color--active': t.color['primary-alt-darkest'],
    '__background-color--disabled': t.color['gray-lighter'],
    '__background-color--hover': t.color['primary-alt-darker'],
    '__background-color': t.color['primary-alt'],
    '__border-color--active': t.color['primary-alt-darkest'],
    '__border-color--disabled': t.color['gray-lighter'],
    '__border-color--hover': t.color['primary-alt-darker'],
