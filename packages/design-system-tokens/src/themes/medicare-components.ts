...
export const components: AnyTokenValues = {
  ...
  'button': {
    '__background-color--active': t.color['primary-alt-darker'],
    '__background-color--disabled': t.color['white'],
    '__background-color--hover': t.color['primary-alt-dark'],
    '__background-color': t.color['white'],
    '__border-color--active': t.color['primary-alt-darker'],
  ...
  'button-alt': {
    '__background-color--active': t.color['primary-darker'],
    '__background-color--disabled': t.color['white'],
    '__background-color--hover': t.color['primary'],
    '__background-color': t.color['white'],
    '__border-color--active': t.color['primary-darker'],
    '__border-color--disabled': 'currentColor',
  ...
  'button-dark-alt': {
    ...
    '__border-color--hover': 'currentColor',
    '__border-color': 'currentColor',
    '__color--active': hexOpacity(t.color['secondary-lighter'], 0.60),
    '__color--disabled': t.color['gray'],
    '__color--hover': hexOpacity(t.color['secondary-lighter'], 0.80),
  ...
  'button-solid-dark': {
    '__background-color--active': hexOpacity(t.color['white'], 0.60),
    '__background-color--disabled': t.color['gray'],
    '__background-color--hover': hexOpacity(t.color['white'], 0.80),
    '__background-color': t.color['white'],
    '__border-color--active': hexOpacity(t.color['white'], 0.60),
    '__border-color--disabled': t.color['gray'],
    '__border-color--hover': hexOpacity(t.color['white'], 0.80),
    '__border-color': t.color['white'],
    '__color--active': t.color['primary-alt'],
    '__color--disabled': t.color['base'],
    '__color--hover': t.color['primary-alt'],
    '__color': t.color['primary-alt'],
  },
