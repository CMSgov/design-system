...
export function AlertTriangleIcon(props: IconCommonProps): React.ReactElement {
  const iconCssClasses = `ds-c-icon--alert-triangle ${props.className || ''}`;

  return (
    <SvgIcon
      title={t('icons.alertTriangle')}
      {...defaultProps}
      {...props}
