...
The examples below assume you've [installed the design system using NPM](https://design.cms.gov/startup/installation/) and have already setup your build system for React.

### Named imports

Components can be imported from the package entry point using the syntax below.

<Alert heading="Performance note" variation="warn" className="ds-u-margin-bottom--2 ds-u-font-size--small">
   <p class="ds-c-alert__text">
      This approach may result in a larger file size than intended. Depending on what module bundler you use, all of the design system's React components may be included in the bundled file even if you didn't specifically import them. This can be avoided by using <a href="https://webpack.js.org/guides/tree-shaking/">tree shaking in Webpack</a>.
    </p>
</Alert>
...
This example assumes you've already added [design system styles via CSS or Sass](https://design.cms.gov/startup/sass-and-css/).
