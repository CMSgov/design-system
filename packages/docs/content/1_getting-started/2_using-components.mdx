...
The examples below assume you've [installed the design system using NPM](/getting-started/installation/) and have already setup your build system for React.
...
This example assumes you've already added [design system styles via CSS or Sass](/getting-started/sass-and-css/).
