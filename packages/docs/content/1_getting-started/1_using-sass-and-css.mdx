...
3. [Ensure fonts and images are rendered correctly.](/getting-started/sass-and-css/#using-fonts-and-images)
...
Alternatively if your project uses Webpack or Create React App, you can [configure the bundler to process the assets](/getting-started/sass-and-css/#setting-asset-paths-to-node_modules).
...
[Learn about the naming conventions](/guidelines/code-conventions)
