...
3. [Ensure fonts and images are rendered correctly.](https://design.cms.gov/startup/sass-and-css/#using-fonts-and-images)
...
Alternatively if your project uses Webpack or Create React App, you can [configure the bundler to process the assets](https://design.cms.gov/startup/sass-and-css/#setting-asset-paths-to-node_modules).
...
Once your page is loading the design system's CSS, you can then begin applying its styling to your pages. Below is an example of a project applying the [base-level of styles](https://design.cms.gov/styles/base) and a [utility class](https://design.cms.gov/utilities/overview).
...
[Learn about the naming conventions](https://design.cms.gov/guidelines/code-conventions)
