...
Then, in your main stylesheet, import your overrides file _before_ you [import the design system's Sass files](/getting-started/sass-and-css/#sass):
...
- [Breakpoints](/guidelines/responsive/)
- [Colors](/styles/color/)
- [Spacing](/styles/spacing/)
- [Type sizes](/styles/typography/)
