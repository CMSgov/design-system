...
Then, in your main stylesheet, import your overrides file _before_ you [import the design system's Sass files](https://design.cms.gov/startup/sass-and-css/#sass):
...
- [Breakpoints](https://design.cms.gov/guidelines/responsive/)
- [Colors](https://design.cms.gov/styles/color/)
- [Spacing](https://design.cms.gov/styles/spacing/)
- [Type sizes](https://design.cms.gov/styles/typography/)
