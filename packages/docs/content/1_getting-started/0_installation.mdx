...
- [Install the `@cmsgov/design-system` package](https://design.cms.gov/startup/installation/#install-using-npm) if your project uses `npm` for package management.

- [Download the design system](https://design.cms.gov/startup/installation/#download-zip) if you are not familiar with `npm` and package management.
