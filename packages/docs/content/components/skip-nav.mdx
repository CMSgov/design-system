...
core:
  ...
  sketchLink: Gm3E1DO
  storybookLink: components-skipnav--docs
healthcare:
  sketchLink: VrPazJr
---
...
<StorybookExample componentName="pagination" storyId="components-skipnav--skip-nav-example" />
...
<SeeStorybookForReactGuidance storyId={'components-skipnav--docs'} />
