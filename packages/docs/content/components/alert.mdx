...
<ThemeContent id="hello-1" onlyThemes={['healthcare']}>
...
<ThemeContent id="hello-2" onlyThemes={['medicare']}>
...
<ThemeContent id="hello-3" onlyThemes={['healthcare']}>
...
<ThemeContent id="hello-4" onlyThemes={['medicare']}>
...
<ThemeContent id="hello-5" onlyThemes={['healthcare']}>
...
<ThemeContent id="hello-6" onlyThemes={['medicare']}>
...
<ThemeContent id="hello-7" onlyThemes={['healthcare']}>
...
<ThemeContent id="hello-8" onlyThemes={['medicare']}>
...
<ThemeContent id="hello-9" onlyThemes={['medicare']}>
...
<ThemeContent id="hello-10" onlyThemes={['medicare']}>
...
<ThemeContent id="hello-11" onlyThemes={['healthcare']}>

Used to show important but not as urgent messages as standard alerts.

</ThemeContent>

<ThemeContent id="hello-12" neverThemes={['medicare']}>
...
<ThemeContent id="hello-13" onlyThemes={['medicare']}>
...
<ThemeContent id="hello-14" onlyThemes={['healthcare']}>
...
<ThemeContent id="hello-15" onlyThemes={['healthcare']}>
...
<ThemeContent id="hello-16" onlyThemes={['healthcare']}>
