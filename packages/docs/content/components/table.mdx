...
<Alert variation="warn" heading="Deprecation Notice">
  The React <code>Table</code> component will eventually be deprecated in favor of{' '}
  <a href="/patterns/html-table">HTML-based patterns</a>.
</Alert>
...
<SeeStorybookForGuidance storyId={'components-table--docs'} />
