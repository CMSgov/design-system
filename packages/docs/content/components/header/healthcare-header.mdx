...
- The menu closes when the user selects or touches anywhere outside it.
...
- With the menu open, press `Escape`. Confirm the menu closes and focus returns to the “Menu” button.
- With the menu open, press `Tab` past the last menu link, or `Shift` + `Tab` before the “Menu”
button. Confirm the menu closes and focus moves to the next element.
