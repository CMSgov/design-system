...
<div className="ds-u-margin-top--2">
  <img src={consistentHeaderPageLevelImg} alt="" class="ds-u-border--1" />
</div>
...
<div className="ds-u-margin-top--2">
  <img src={consistentHeaderSlideOutDrawerImg} alt="" class="ds-u-border--1" />
</div>
...
The Medicare.gov header has been tested against, and meets, the WCAG 2.1 standard for
accessibility.

- The header includes the [Skip Nav](/components/skip-nav/?theme=medicare) component.
- The header includes the [USA-banner](/components/usa-banner/?theme=medicare) component. [Read more about testing USA Banner’s accessibility](/components/usa-banner/#accessibility-testing).
- The header includes the [Medicare.gov logo](/components/logos/medicare-logo/?theme=medicare). [Read more about testing the logo’s
...
- Use the `Tab` key to move forward and `Shift` + `W` to move backward
