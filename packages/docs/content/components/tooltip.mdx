...
This component makes use of [Floating UI](https://floating-ui.com/) for tooltip positioning and [`react-transition-group`](http://reactcommunity.org/react-transition-group/css-transition) for animations.
