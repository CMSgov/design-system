...
This component makes use of [`@popperjs/core`](https://popper.js.org/docs/v2/) for tooltip positioning and [`react-transition-group`](http://reactcommunity.org/react-transition-group/css-transition) for animations.
