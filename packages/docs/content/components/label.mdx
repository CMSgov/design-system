---
title: Label & Legend
intro: Labels & legends are used with form inputs to provide labels, hints, and errors that help the user enter information.
core:
...
The `Label` component provides the `label` (or `legend`) for a field, along with any associated hint text and error message.

<StorybookExample
  componentName="formLabel"
  sourceFilePath="components/Label/Label.tsx"
  storyId="components-formlabel--label-with-hint"
/>
...
<SeeStorybookForReactGuidance storyId={'components-label--docs'} />
