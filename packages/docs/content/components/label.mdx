...
- Content style for labels varies based on the user experience and its goals.
  ...
  - Form labels and decision helpers can use imperatives or questions for user understanding or conversational feel. (Examples: "Tell us why you need a faster decision." "Select a reason for your request." "Do you want to see costs when you compare X?" "Do you have another mailing address?") With imperatives and questions include punctuation.
- Use a phrase or complete sentence. If using a complete sentence, include punctuation.
- For imperative labels, start with an action verb and pair it with a noun to help it be clearer. Example: "Enter your age."
- Use the fewest words possible. Don't use "please" or add unnecessary explanation/context in your label. Instead, use hint text or a help drawer to provide information the user must have to correctly enter their answer. 
- Use sentence case.
