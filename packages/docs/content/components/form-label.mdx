...
core:
  ...
  storybookLink: components-form-label--docs
---
...
<StorybookExample
  ...
  storyId="components-form-label--form-label-with-hint"
/>
...
<SeeStorybookForReactGuidance storyId={'components-form-label--docs'} />
