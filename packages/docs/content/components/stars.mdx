...
status:
  level: caution
  note: Use caution when implementing Stars. This component hasn't been tested with screen readers, and may be inaccessible to people who rely on screen readers.
