...
import { Alert, ArrowIcon, Button, TextInput } from '@cmsgov/design-system';
...
Alternate buttons can exist in each of the three main variations (outline, solid, ghost) but stand apart as having an alternate color. In the core design system, these follow the secondary brand color.
