...
<Table stackable stackableBreakpoint="md" className="ds-u-margin-bottom--2">
    ...
    <TableRow>
      ...
      <TableCell>
        <ThemeContent onlyThemes={['healthcare', 'medicare']}>
          <CloseIcon className="ds-c-icon-color--error" /> Unused
        </ThemeContent>
      ...
      <TableCell className="ds-base--inverse">
        <ThemeContent onlyThemes={['healthcare', 'medicare']}>
          <CloseIcon className="ds-c-icon-color--error" /> Unused
        </ThemeContent><ThemeContent neverThemes={['healthcare', 'medicare']}>
    ...
    <TableRow>
      ...
      <TableCell>
        <ThemeContent onlyThemes={['healthcare']}>
          <CloseIcon className="ds-c-icon-color--error" /> Unused
        </ThemeContent><ThemeContent neverThemes={['healthcare']}>
