...
Fusce porttitor velit ut lorem suscipit, sed sodales nibh volutpat. Cras sed rhoncus massa. Aliquam erat volutpat. Donec sagittis ex lectus, quis semper leo mattis ut. Donec nec odio non risus convallis cursus in eu lacus. Integer vitae placerat quam, eu dignissim elit. Cras dapibus felis felis, et vehicula nisi venenatis eu. Fusce condimentum nec quam tempus faucibus. Maecenas sollicitudin nibh malesuada scelerisque faucibus.
...
import { Alert, ArrowIcon, Button } from '@cmsgov/design-system';
...
<ThemeContent onlyThemes={['healthcare', 'medicare']}>
  ...
  #### Outline alternate button (Unused)
...
Generally better to use specific verbs to confirm what the user is starting. Example: "Create Account."

<table class="ds-c-table ds-c-md-table--stacked" role="table" width="100%">
  <thead role="rowgroup">
    <tr role="row">
...
- Use: "Continue" for forward movement to the next page tr step
  - Don't use: "Next"
  - Note: Explore clarity of using Next instead of Continue, especially for unauthenticated
- Use: "Back" or "Go Back" for backwards movement to the previous step in the process
  - Don't use: "Undo" or "Cancel"
  - Note: Back is technically a navigational element and should be a link depending on the placement within the design.

##### Stopping a process or translation and return to beginning
- Use: "Cancel" It appears on the first step of forms. 
  - Don't use: "X."

##### Submiting information or completing a process

- Use: "Enter," "Go," or "Submit" - But generally better to use specific verbs if appropriate to confirm an action. 
  - Don't use: "Fill in," "Tell us," "Done," or "Select" .

#### Logging in and logging out

- Use: "Log in" - MUST be 2 words and "in" is lowercase when it's an action.
  - Don't use: "Login," "Sign in," or "Signin."
  - "Login" is used as 1 word when it's a noun or adjective.
- Use: "Log out" - MUST be 2 words and "out" is lowercase when it's an action.
  - Don't use: "Logoff,", "Log off," "Logout," "Signout," or "Sign out."
  - "Logout" is used as 1 word when it's a noun or adjective.
- Use: "Username" - MUST be 1 word 
  - Don't use: "User name."
