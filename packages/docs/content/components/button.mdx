...
- Buttons always start with an action verb describing the main thing users will do once selected. 
  - Pair it with a noun to help it be clearer. Example: Get tips.
  - If in a form, it can be just the action verb if it's navigating between steps. Example: Cancel, Back, Next.
