...
Action buttons allow people to take actions from a current state to a future state. They are promises to the user; they must deliver the promise they offer by doing what the button says it would do.
...
See Content Guidelines in top tab for more information.
...
- Buttons use sentence case. Example: Update application.
...
- Use: "Start" - to start a process or sequential steps. But generally better to use specific verbs to confirm what the user is starting. Example: "Create Account."
  - Don't use: "Begin," "Go," "Enter," or "Submit."
- Use: "Continue" - when moving through a process or sequential steps.
  - Don't use: "Next."
  - Note: Explore clarity of using Next instead of Continue, especially for unauthenticated
- Use: "Cancel" - to completely stop a process or translation and return to beginning. It appears on the first step of forms. 
  - Don't use: "X."
- Use: "Back" or "Go Back" - to return to the previous step in the process. 
...
- Use: "Enter," "Go," or "Submit" - to submit information. But generally better to use specific verbs if appropriate to confirm an action. 
