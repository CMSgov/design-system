...
<EmbeddedExample>
  <div>
    <Button className="ds-u-margin-right--1"><ArrowIcon direction="left" className="ds-u-margin-right--05" /> Left Icon</Button>
    <Button className="ds-u-margin-right--1">Right Icon <ArrowIcon direction="right" className="ds-u-margin-left--05" /></Button>
  </div>
</EmbeddedExample>
...
<EmbeddedExample>
  <div>
    <Button className="ds-u-margin-right--1">Back</Button>
    <Button variation="solid" className="ds-u-margin-right--1">Next</Button>
  </div>
</EmbeddedExample>
