...
import { ArrowIcon, Badge, Button } from '@cmsgov/design-system';
...
#### Outline alternate button <ThemeContent onlyThemes={['healthcare', 'medicare']}><Badge variation="alert">Unused</Badge></ThemeContent>
...
#### Solid alternate button <ThemeContent onlyThemes={['healthcare']}><Badge variation="alert">Unused</Badge></ThemeContent>
...
#### Ghost alternate button <ThemeContent onlyThemes={['healthcare', 'medicare']}><Badge variation="alert">Unused</Badge></ThemeContent>
...
### On dark background <ThemeContent onlyThemes={['healthcare']}><Badge variation="alert">Unused</Badge></ThemeContent>
