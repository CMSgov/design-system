...
- Focus moves forward with keyboard interaction. When you navigate through items with the tab key, the order in which the visible focus proceeds from item to item is logical. (For example, the focus doesn’t skip a
link or accordion heading.)
