...
To verify keyboard support for the Accordion header, press `Enter` or `Spacebar`. This toggles the collapsed/expanded state of the associated accordion panel.
