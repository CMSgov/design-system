...
core:
  ...
  sketchLink: xrmY9oJ
  storybookLink: components-multi-input-date-field--docs
healthcare:
  sketchLink: wLOVybw
medicare:
  sketchLink: ka7OOgR
...
<StorybookExample
  ...
  storyId="components-multi-input-date-field--multi-input-date-field-default"
/>
...
<SeeStorybookForReactGuidance storyId={'components-multi-input-date-field--docs'} />
