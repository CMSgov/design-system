...
- Hint text should meet [size and contrast requirements](/foundation/typography/body/#accessibility).
...
<SeeStorybookForGuidance tech="wc" storyId={'web-components-ds-hint--docs'} />
