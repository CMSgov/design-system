...
- Make sure that the icon has a minimum contrast ratio of 3:1 against its
background.
- If icons accompany a text link, place the icon inside the link to prevent screen
readers from announcing the link twice.
