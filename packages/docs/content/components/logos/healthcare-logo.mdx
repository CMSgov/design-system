...
- There are two variants of the HealthCare.gov identity marker that should be used sparingly. The first is a white marker against black. The second is a gray version. Both are intended to be used as "tags" in areas such as a footer where subtle use of the mark is appropriate.
