...
<Alert heading="Use semantic grouping and accessible layouts">
  For forms with thematically related grouped inputs (such as date of birth or address fields), use a <code>&lt;fieldset&gt;</code> with a <code>&lt;legend&gt;</code> to provide semantic grouping. This helps screen reader users navigate and understand the structure of the form.
  <br /><br />
