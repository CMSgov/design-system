...
<EmbeddedExample>
    <section class="example-list">
        ...
        <article>
            ...
            <div class="ds-u-font-size--base">{loremIpsumGenerator('s')}</div>
        </article>
        <article>
            <code class="ds-u-margin-y--0 ds-u-margin-bottom--1">.ds-u-font-size--sm</code>
            <div class="ds-u-font-size--sm">{loremIpsumGenerator('s')}</div>
        </article>
    </section>
