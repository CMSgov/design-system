...
<EmbeddedExample>
  <div>
    ...
    <div class="ds-u-margin-bottom--2">
      ...
      <div class="utility-example" style={{ minHeight: 2 }}>
...
Use a [breakpoint prefix](/foundation/layout-grid/responsive-design/) to show/hide content at specific breakpoints.
