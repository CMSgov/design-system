...
<EmbeddedExample>
  <section>
    <article class="ds-u-margin-top--2">
      ...
      <div class="ds-u-radius ds-u-fill--secondary ds-u-padding--2" style={{ width: 100 }}></div>
    </article>
    <article class="ds-u-margin-top--2">
    ...
    <article class="ds-u-margin-top--2">
      ...
      <div class="ds-u-radius--circle ds-u-fill--secondary" style={{ width: 50, height: 50 }}></div>
    </article>
  </section>
</EmbeddedExample>
