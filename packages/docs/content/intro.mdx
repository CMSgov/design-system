...
- **Recommended option:** [Install the NPM package](/getting-started/installation#install-using-npm) `@cmsgov/design-system` if your project uses npm for package management.
...
- Reducing the overall footprint of websites by writing [scalable CSS](/guidelines/code-conventions/).
...
- Reducing the number of decisions needed when iterating on UI by providing a solid foundation of [typography](/styles/typography/), [layout](/utilities/layout-grid/), and [color](/styles/color-palette/).
- Distributing resources as [NPM packages](/getting-started/installation/) which can be easily installed, updated, and imported.
