...
The design system is a set of open source design and front-end development resources for creating Section 508 compliant, responsive, and consistent websites. It builds on the U.S. Web Design System and extends it to support additional CSS and React components, [utility classes](https://design.cms.gov/utilities/overview), and a [grid framework](https://design.cms.gov/utilities/grid/) to allow teams to quickly prototype and build accessible, responsive, production-ready websites.
...
- **Recommended option:** [Install the NPM package](https://design.cms.gov//startup/installation/) `@cmsgov/design-system` if your project uses npm for package management.
...
- Reducing the overall footprint of websites by writing [scalable CSS](https://design.cms.gov/guidelines/code-conventions).
- Supporting rapid development with [utility classes](https://design.cms.gov/utilities/overview) and easy-to-use components with best practices baked in.
- Reducing the number of decisions needed when iterating on UI by providing a solid foundation of [typography](https://design.cms.gov/styles/typography), [layout](https://design.cms.gov/utilities/grid/), and [color](https://design.cms.gov/styles/color).
- Distributing resources as [NPM packages](https://design.cms.gov/startup/installation/) which can be easily installed, updated, and imported.
