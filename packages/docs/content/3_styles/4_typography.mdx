...
<Alert heading="Typography sizing updates!" >
  <p class="ds-c-alert__text">
    We've updated typography sizing variables and class names to make them more agnostic. Read about <a href="/getting-started/theming/#updating-font-sizing">how you can update</a>.
  </p>
</Alert>
...
<EmbeddedExample>
  <article>
    <h2 class="ds-h6" id="unordered-list-id">Unordered list</h2>
...
<EmbeddedExample>
  <article>
    <h2 class="ds-h6" id="ordered-list-id">Ordered list</h2>
    <code class="ds-u-margin-y--0 ds-u-margin-bottom--1">.ds-c-list</code>
...
<EmbeddedExample>
  <article>
    <h2 class="ds-h6" id="unstyled-list-id">Unstyled list</h2>
...
<ResponsiveExample storyId='typography-responsive--headings' title="Responsive typography example" />
