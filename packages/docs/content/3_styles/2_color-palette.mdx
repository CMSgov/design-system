...
<ColorSwatchList colorNames={['primary', 'primary-darker', 'primary-darkest', 'black', 'base', 'gray-dark', 'gray-light', 'white']} preface="$color-"/>
...
<ColorSwatchList colorNames={[ 'primary-alt-darkest', 'primary-alt-dark', 'primary-alt', 'primary-alt-light',
'primary-alt-lightest' ]} preface="$color-" />
...
<ColorSwatchList colorNames={[ 'background', 'background-inverse', 'gray-dark', 'gray', 'gray-light',
'gray-lighter', 'gray-lightest' ]} preface="$color-" />
...
<ColorSwatchList colorNames={[ 'success-darkest', 'success-darker', 'success-dark', 'success', 'success-light',
'success-lighter', 'success-lightest', 'warn-darkest', 'warn-darker', 'warn-dark', 'warn',
'warn-light', 'warn-lighter', 'warn-lightest', 'error-darkest', 'error-darker', 'error-dark',
'error', 'error-light', 'error-lighter', 'error-lightest', ]} preface="$color-" />
