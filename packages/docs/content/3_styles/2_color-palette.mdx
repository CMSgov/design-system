...
<ColorSwatchList colorNames={['primary', 'primary-darker', 'primary-darkest', 'black', 'base', 'gray-dark', 'gray-light', 'white']} />
...
'error', 'error-light', 'error-lighter', 'error-lightest', ]} />

## Focus colors

<ColorSwatchList colorNames={[ 'focus-color-light' , 'focus-color-dark' ]} />

## Additional colors

<ColorSwatchList colorNames={[ 'muted-inverse','transparent' ]} />
