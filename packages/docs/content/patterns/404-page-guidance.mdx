...
#### 404 page center-aligned

<StorybookExample
    componentName="center-aligned"
    storyId="patterns-404-page-guidance--center-aligned"
    minHeight={500}
/>

#### 404 page left-aligned

<StorybookExample
    componentName="left-aligned"
    storyId="patterns-404-page-guidance--left-aligned"
    minHeight={500}
/>

<ThemeContent onlyThemes={['healthcare']}>404 Page with search option</ThemeContent>
...
- Let users know what they can do next. This might be advice such as correctin typos in the URL address and updating bookmarks when they find the page they want.
- Give users a way out of the "dead end" error page by directing them to the call to action (CTA). This CTA can be a search option to find the page they are looking for or a button leading users to a homepage. If using a button, users should be redirected to the following pages for each theme:
  ...
  - **Medicare**: [www.medicare.gov/](www.medicare.gov/)
  - **CMS**: [www.cms.gov/](www.cms.gov/)
...
- Both center-aligned and left-aligned 404 page designs are available. Your choice should be guided by the context of your website and the content on the 404 page itself.
...
- Do no use this pattern if a website has been taken down for maintenance.
...
- The page ust be fully responsive, displaying correctly on all screen sizes, from mobile devices to desktop computers.
...
In addition to [component level analytics events](https://design.cms.gov/components/analytics/?theme=core), it is recommended [insert Blast documentation link here] that you implement analytics recording on these additional events:
