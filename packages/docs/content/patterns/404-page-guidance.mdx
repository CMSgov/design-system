...
For teams that need a self-contained 404 page with no dependence on the larger Design System, we offer a "lite" 404 page for use. Download the [404 Lite HTML file](404-lite.html), add your own analytics code, and upload it to the appropriate environment.
