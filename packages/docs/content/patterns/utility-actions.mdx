...
<EmbeddedExample>
  <div className="ds-l-row">
    <div className="ds-l-col--6">
      <button className="ds-c-button ds-c-button--ghost">
        <PrintIcon className="ds-u-margin--05" viewBox="0 0 32 32" />
        Print
      </button>
    </div>
    <div className="ds-l-col--6">
      <button className="ds-c-button ds-c-button--ghost">
        <EmailIcon className="ds-u-margin--05" viewBox="0 0 32 32" />
        Email
      </button>
    </div>
    <div className="ds-l-col--6">
      <button className="ds-c-button ds-c-button--ghost">
        <RssIcon className="ds-u-margin--05" viewBox="0 0 32 32" />
        RSS
      </button>
    </div>
    <div className="ds-l-col--6">
      <button className="ds-c-button ds-c-button--ghost">
        <LinkIcon className="ds-u-margin--05" viewBox="0 0 32 32" />
        Link
      </button>
    </div>
    <div className="ds-l-col--6">
      <button className="ds-c-button ds-c-button--ghost">
        <DownloadIcon className="ds-u-margin--05" viewBox="0 0 18 18" />
        Download
      </button>
    </div>
    <div className="ds-l-col--6">
      <button className="ds-c-button ds-c-button--ghost">
        <WhatsNewIcon className="ds-u-margin--05" viewBox="0 0 32 32" />
        What's New
      </button>
    </div>
  </div>
