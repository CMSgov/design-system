...
Weʼve restructured form-field labels to improve accessibility, customizability, and clarity of guidance. You can read about this change in more detail in [this migration guide](/migration-guides/v9-label-updates), but the gist is that labels used to contain both hints and inline-error messages and now theyʼre separate components.
...
<div className="ds-u-text-align--center ds-u-margin-top--3">
  <img
    ...
    alt="Screenshots showing the X close button in the dialog in unfocused and focused modes"
  />
</div>
