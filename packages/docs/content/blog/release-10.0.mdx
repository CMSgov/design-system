...
If your team is still using `ds-h1` or similar deprecated classes, you can use our migration script (`npx cmsds-migrate` or `yarn cmsds-migrate`) to automatically update your old classes to the new classes.  
