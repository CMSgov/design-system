...
In this update, we’ve resolved this issue by implementing the component as an ARIA combobox. A side benefit is that CMS brands can now customize the look and feel of the menu. The component has been redesigned from the ground up, and our Autocomplete component has also been updated to match the new designs. [Check out the Dropdown page to see it in action](https://design.cms.gov/components/dropdown/).
...
Please [check out our new example projects on GitHub](https://github.com/CMSgov/design-system/tree/main/examples/) and [read our updated developer documentation](https://design.cms.gov/getting-started/for-developers/#using-components) for more details.
