...
The current browser support for the design system [can be viewed here](/getting-started/browser-support/). We test with the following assistive technology pairings:
