...
<Alert variation="warn" heading="First and last children">
  ...
  ```html
    <form>
      ...
      <h1>I'm not the first child of my parent</h1>
      <div>
        <h2>I'm actually the first child of my parent even though I'm not the first heading on the page</h2>
        <h2>I'm the last child of my parent</h2>
      </div>
      <h1>I'm also the last child of my parent</h1>
    </form>
  ```
