...
<EmbeddedExample>
      <h4 class="ds-text-heading--5xl">{loremIpsumGenerator('s')}</h4>
</EmbeddedExample>
</ThemeContent>
...
<ThemeContent neverThemes={['medicare']}>
<EmbeddedExample>
      <h4 class="ds-text-heading--4xl">{loremIpsumGenerator('s')}</h4>
</EmbeddedExample>
</ThemeContent>
...
<EmbeddedExample>
      <h4 class="ds-text-heading--3xl">{loremIpsumGenerator('s')}</h4>
</EmbeddedExample>

### Heading--2xl

<EmbeddedExample>
      <h4 class="ds-text-heading--2xl">{loremIpsumGenerator('s')}</h4>
</EmbeddedExample>

### Heading--xl

<EmbeddedExample>
      <h4 class="ds-text-heading--xl">{loremIpsumGenerator('s')}</h4>
</EmbeddedExample>

### Heading--lg

<EmbeddedExample>
      <h4 class="ds-text-heading--lg">{loremIpsumGenerator('s')}</h4>
</EmbeddedExample>

### Heading--md

<EmbeddedExample>
      <h4 class="ds-text-heading--md">{loremIpsumGenerator('s')}</h4>
</EmbeddedExample>

### Heading--sm

<EmbeddedExample>
      <h4 class="ds-text-heading--sm">{loremIpsumGenerator('s')}</h4>
</EmbeddedExample>

### Link Heading
<EmbeddedExample>
   <h4 class="ds-text-heading--lg"><a href="javascript:void(0);">{loremIpsumGenerator('s')}</a></h4>
</EmbeddedExample>
...
<EmbeddedExample>
      <h4 class="ds-text-heading--lg ds-u-color--primary">Teal heading</h4>
...
<h5 class="ds-text-heading--md ds-u-margin-bottom--0">Eyebrow header</h5>
<h4 class="ds-text-heading--3xl ds-u-margin--0">Main header</h4>
...
<h4 class="ds-text-heading--2xl">Heading--2xl</h4>
...
<h4 class="ds-text-heading--lg">Heading--lg</h4>
