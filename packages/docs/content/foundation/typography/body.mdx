...
<Alert heading="Typography sizing updates!">
  <p class="ds-c-alert__text">
    ...
    presentation. Read about how{' '}
    <a href="https://design.cms.gov/migration-guides/agnostic-typography-classes">you can update</a>.
  </p>
</Alert>
...
- If you need to stray from the default body text color and default page background color, make sure your color combinations provide sufficient color contrast:
  ...
  - For more information, check out the following resources:
    - [WCAG Understanding Docs for success criterion 1.4.3 Contrast (Minimum) (Level AA)](https://www.w3.org/WAI/WCAG21/Understanding/contrast-minimum)
...
- Don't use Rubik font for headers
- Don't use a header that is smaller than the body font size
- Don't have stray headers in the body of your page
