...
<Alert
  variation="warn"
  heading="The CMS Design System v4 release introduces an updated button architecture that is not backward compatible with previous versions of the design system."
>
...
<img
  alt="3 columns of buttons that are mismatched across the entire design system. Screenshot."
  src={oldButtons}
  class="ds-u-border--1"
/>
...
<img
  alt="3 columns of buttons with the first column being a complete set of buttons and column 2 and 3 containing subsets of buttons. Screenshot."
  src={newButtons}
  class="ds-u-border--1"
/>
...
The updated button structure in Sketch will be organized into 2 main groups on light and on dark and then from there will be categorized by style of button - solid, outline, and ghost. For each style of button there are main and alternate options available.
...
<img
  ...
  src={sketchButtonStructure}
  class="ds-u-border--1"
/>

<Alert
  heading="The Ω_Unused and Ω_Subcomponent folders are for categorization only"
  weight="lightweight"
  className="ds-u-margin-top--2"
>
  These folders contain elements that are not used within the theme and appear at the bottom of the
