...
<EmbeddedExample>
    <div>
        <code class="ds-u-diaplay--block ds-u-padding--1 utility-example"> .ds-u-diaplay--block </code>
        <code class="ds-u-diaplay--flex ds-u-padding--1 utility-example"> .ds-u-diaplay--flex </code>
        <code class="ds-u-diaplay--inline ds-u-padding--1 utility-example"> .ds-u-diaplay--inline </code>
        <code class="ds-u-diaplay--inline-block ds-u-padding--1 utility-example"> .ds-u-diaplay--inline-block </code>
        <code class="ds-u-diaplay--none ds-u-padding--1 utility-example"> .ds-u-diaplay--none </code>
    </div>
</EmbeddedExample>
...
<EmbeddedExample>
    <div class="example--wrapper">
        ...
        <div>
            ...
            <div class="preview__element" style="min-height: 2px">
...
<ResponsiveExample storyId='utilities-visibility--visbility' title="Responsive visibility grid example" />
