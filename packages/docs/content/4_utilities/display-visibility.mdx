...
<EmbeddedExample>
    <div>
        ...
        <code class="ds-u-display--flex ds-u-padding--1 ds-u-margin-bottom--2 utility-example"> .ds-u-display--flex </code>
        <code class="ds-u-display--inline ds-u-padding--1 ds-u-margin-bottom--2 utility-example"> .ds-u-display--inline </code>
        <code class="ds-u-display--inline-block ds-u-padding--1 ds-u-margin-bottom--2 utility-example"> .ds-u-display--inline-block </code>
...
<ResponsiveExample storyId='utilities-visibility--visibility' title="Responsive visibility example" />
