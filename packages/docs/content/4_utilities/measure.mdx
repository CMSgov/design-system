...
<EmbeddedExample>
    <section class="example-list">
        <article>
            ...
            ><code>.ds-u-measure--narrow</code> (line length ~45 characters)</span
            >
            <div class="ds-u-measure--narrow">{loremIpsumGenerator('l')}</div>
        </article>
        <article>
            <span class="example-label"
            ><code>.ds-u-measure--base</code> (line length ~65 characters)</span
            >
            <div class="ds-u-measure--base">{loremIpsumGenerator('l')}</div>
        </article>
        <article>
            <span class="example-label"
            ><code>.ds-u-measure--wide</code> (line length ~80 characters)</span
            >
