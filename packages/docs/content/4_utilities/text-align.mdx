...
Use a [breakpoint prefix](/guidelines/responsive-design) to change the text alignment at specific breakpoints.

<ResponsiveExample storyId="utilities-text-align--text-align" title="Responsive text align example" />