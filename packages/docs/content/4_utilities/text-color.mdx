...
## Text on `.ds-u-fill--primary-alt-lightest` background
<ColorSwatchList
    backgroundClass='ds-u-fill--primary-alt-lightest'
    preface='.ds-u-color--'
    colorNames={[
        'base', 
        'gray', 
...
<EmbeddedExample>
    <div class="ds-u-color--error">
        This is an example of <a href="#" class="ds-u-color--inherit">a link</a> with the class `ds-u-color--error` error styling.
    </div>
</EmbeddedExample>
