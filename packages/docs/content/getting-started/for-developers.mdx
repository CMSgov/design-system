...
For all the other styles to have the right typography styles, the root of your page content should have a `ds-base` class applied to it. Please see [our base styles documentation](/foundation/base) for more details.
