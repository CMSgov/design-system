...
To start off, for all your elements to inherit the correct typographical properties, the root of your page content should have a `ds-base` class applied to it. Please see [our base styles documentation](/foundation/base) for more details.
