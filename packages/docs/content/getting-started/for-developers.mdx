...
While you can actually use Preact inside code that was written for React—and [the preact-react-app example](https://github.com/CMSgov/design-system/tree/main/examples/preact-react-app) shows you how—we've also provided an import path for you to use the Preact version of our components directly. To import the Preact versions, add `/preact` to the end of your import path like this:
