...
- The request involves documentation updates, usage guidance, or content rather than a new visual or functional design element. Share these types of requests through one of our Slack channels, which you can access in [#cms-design-system](https://cmsgov.slack.com/archives/CHH0381RD). If you do not have access to CMS internal tools, use the [public GitHub issue template](https://github.com/CMSgov/design-system/issues/new?template=propose-a-new-item-for-the-cms-design-system.md) to submit a new issue.
