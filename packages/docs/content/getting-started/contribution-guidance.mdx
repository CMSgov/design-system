...
- **Components:** Reusable UI elements with defined functions and behaviors. These are the building blocks of the design system. Examples include buttons, checkboxes, and text inputs.
- **Patterns:** Combinations of components used together to solve common user interactions. Examples include form reviews or utility actions.
