...
- The request involves documentation updates, usage guidance, or content rather than a new visual or functional design element. Share these types of requests through the [#cms-design-system](https://cmsgov.slack.com/archives/CHH0381RD) Slack channel.
- If you do not have access to CMS internal tools, submit your request using the [public GitHub issue template](https://github.com/CMSgov/design-system/issues/new?template=propose-a-new-item-for-the-cms-design-system.md).
...
2. **Submit a contribution proposal:** If you have access to CMS internal tools, complete and submit a [contribution proposal form](https://confluence.cms.gov/spaces/HCDSG/pages/984161621/Contribution+Proposals). Include any relevant images, discovery research, or Figma files associated with your design. If you do not have access to CMS internal tools, submit your proposal using the [public GitHub issue template](https://github.com/CMSgov/design-system/issues/new?template=propose-a-new-item-for-the-cms-design-system.md).
