...
describe('ReactPropDoc', () => {
  it('should render name', () => {
    ...
    expect(data.wrapper.find('td').first().text())
  ...
  it('should render "required"', () => {
    ...
    expect(data.wrapper.find('td .ds-c-badge').first().text())
      .toBe('Required');
  });
  ...
  it('should render type', () => {
    ...
    expect(data.wrapper.find('td').at(1).text())
  ...
  it('should render default value', () => {
    ...
    expect(data.wrapper.find('td').at(2).text())
  ...
  it('should render description', () => {
    ...
    expect(data.wrapper.find('td').at(3).html())
      .toMatch(/bar/);
  });
