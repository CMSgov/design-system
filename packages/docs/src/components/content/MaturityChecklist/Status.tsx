...
const Status = ({ status }: StatusProps) => {
  if (status === true) {
    return (
      <>
        <SvgIcon ariaHidden title="" viewBox="0 0 24 24" className="ds-c-icon-color--success">
          <path
            fillRule="nonzero"
    ...
    return (
      <>
        ...
        <span className="ds-text-body--sm ds-u-margin-x--1">Not applicable</span>
      </>
    );
  } else {
    return (
      <>
        <SvgIcon ariaHidden title="" viewBox="0 0 24 24" className="ds-c-icon-color--error">
          <path
            fillRule="nonzero"
