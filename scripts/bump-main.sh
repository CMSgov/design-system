...
gh pr create --base main --title "[RELEASE] $(date '+%m/%d') Version bump main" --body "Please review version updates and compare against latest release branch" --reviewer "zarahzachz" --reviewer "pwolfert"
