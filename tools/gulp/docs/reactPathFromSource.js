...
function reactPathFromSource(path, name) {
  ...
  // Example: packages/design-system/components/Button.scss -> design-system/component/Button
  path = path.match(/packages\/([a-z0-9_\-/]+)/i)[1];

  // Replace the filename with the component's name
  // Example: design-system/component/Button -> design-system/component/ButtonGroup
