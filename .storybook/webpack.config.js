...
// because of the way font files are organized in dev vs prod, need to have a different font path
// need to set this before styles are imported
const getFontPath = () => {
  // for prod builds
  if (process.env.STORYBOOK_ENV !== 'dev') {
    return `$font-path: './fonts';`;
  }
    ...
    },
    {
      ...
      use: [
        ...
        'css-loader?url=false',
        {
          loader: 'sass-loader',
          options: {
            additionalData: `${getFontPath()} @import '${getStylesPath()}';`,
          },
        },
      ],
      include: path.resolve(__dirname, '../'),
